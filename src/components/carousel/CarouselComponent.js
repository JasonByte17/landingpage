...
import { itemsCarousel } from '../../data/itemsCarousel';
...
const CarouselComponent = (args) => {
  ...
  const slides = itemsCarousel.map((item) => {
    return (
      <CarouselItem
  ...
  return (
    <Carousel
      ...
      {...args}
    >
      <CarouselIndicators items={itemsCarousel} activeIndex={activeIndex} onClickHandler={goToIndex} />
      {slides}
